...
>
> 单位：每百万 token。高峰时段 = 北京时间**周一至周五** 9:00-12:00、14:00-18:00（即 UTC 01:00-04:00、06:00-10:00），价格翻倍；**周末全天为空闲时段**。
>
...
4. **峰谷判定**：按该回复的时间戳判断——高峰时段（北京**周一至周五** 9:00-12:00、14:00-18:00）三档价格全部 × 2，周末与其余时段按空闲价
